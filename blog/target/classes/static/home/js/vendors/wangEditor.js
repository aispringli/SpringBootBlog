...
*/
    ...
    var config = {
        ...
        // 默认菜单配置
        menus: ['head', 'bold', 'fontSize', 'fontName', 'italic', 'underline', 'strikeThrough', 'foreColor', 'backColor', 'link', 'list', 'justify', 'quote', 'emoticon', 'image', 'table', 'video', 'file', 'code', 'undo', 'redo'],
        ...
        // 上传图片的自定义header
        uploadImgHeaders: {
            'X-CSRF-TOKEN': document.getElementsByTagName('meta')['_csrf'].getAttribute('content')
            // 'Accept': 'text/x-json'
        },
...
// 构造函数
    function File(editor) {
        this.editor = editor;
        var imgMenuId = getRandom('w-e-file');
        this.$elem = $('<div class="w-e-menu" id="' + imgMenuId + '"><i class="fa fa-file" aria-hidden="true"></i></div>');
