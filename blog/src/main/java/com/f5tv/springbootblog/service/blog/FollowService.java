...
public class FollowService {
    ...
    public ResponseResult followInsert(FollowEntity followEntity) {
        ...
        if (followMapper.insert(followEntity) > 0) return new ResponseResult(0, true, "关注成功");
    ...
    public ResponseResult followDelete(FollowEntity followEntity) {
        if (followMapper.deleteByFollowId(followEntity) > 0) return new ResponseResult(0, true, "取消关注成功");
